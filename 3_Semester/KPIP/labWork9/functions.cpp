...
void menuForSearchByTheOption(std::ifstream &file, const std::string &textFileName, const std::string &binaryFileName, int seekChoice)
{
    ...
    std::cout << "1 to search by name" <<std::endl;
    std::cout << "2 to search by kitchen" <<std::endl;
    std::cout << "3 to search by price" <<std::endl;
    std::cout << "Your choice is >> " << std::endl;
    choice = intInputValidation();
...
int menuForChooseOption()
{
    ...
    std::cout << "2 to sort by kitchen" <<std::endl;
    std::cout << "3 to sort by price" <<std::endl;
    std::cout << "Your choice is >> " << std::endl;
    choice = intInputValidation();
    while (choice < 1 || choice > 3)
    {
...
{
    int choice;
    std::cout << "1 to delete by name" <<std::endl;
    std::cout << "2 to delete by kitchen" <<std::endl;
    std::cout << "3 to delete by price" <<std::endl;
    std::cout << "Your choice is >> " << std::endl;
    choice = intInputValidation();
    while (choice < 1 || choice > 3)
    {
